...
async def get_menu_or_404(db: Session, menu_id: str) -> Menu:
...
async def get_submenu_or_404(db: Session, submenu_id: str) -> Submenu:
...
async def get_dish_or_404(db: Session, dish_id: str) -> Dish:
